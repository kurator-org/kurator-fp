...
public class PythonActor extends UntypedActor {
    ...
    public PythonActor(Map<String,Object> settings, Map<String,Object> configuration) throws Exception {
    ...
    protected synchronized void loadCustomCode() throws Exception {
        ...
        if (moduleConfig != null) {
            ...
            System.out.println("Actor " + this.name + " imported module " + moduleConfig + " from " + modulePath);
            functionQualifier = moduleConfig + ".";

            // change directory to the location of the python actor script
            //interpreter.exec("abspath = os.path.abspath(" + moduleConfig + ".__file__)");
            //interpreter.exec("dname = os.path.dirname(abspath)");
            //interpreter.exec("os.chdir(dname)");

            //interpreter.exec("print dname");
        }        
    }
    ...
    private void publishArtifacts(Map<String, String> artifacts) {
