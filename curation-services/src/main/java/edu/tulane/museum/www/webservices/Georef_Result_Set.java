...
public class Georef_Result_Set  implements java.io.Serializable {
    ...
    private edu.tulane.museum.www.webservices.Georef_Result[] resultSet;
    ...
    public Georef_Result_Set(
           ...
           edu.tulane.museum.www.webservices.Georef_Result[] resultSet) {
     ...
     * @return resultSet
     */
    public edu.tulane.museum.www.webservices.Georef_Result[] getResultSet() {
        return resultSet;
    }
    ...
    public edu.tulane.museum.www.webservices.Georef_Result getResultSet(int i) {
        return this.resultSet[i];
    }

    public void setResultSet(int i, edu.tulane.museum.www.webservices.Georef_Result _value) {
        this.resultSet[i] = _value;
    }

    private Object __equalsCalc = null;
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof edu.tulane.museum.www.webservices.Georef_Result_Set)) return false;
        edu.tulane.museum.www.webservices.Georef_Result_Set other = (edu.tulane.museum.www.webservices.Georef_Result_Set) obj;
    ...
    public synchronized int hashCode() {
        ...
        if (getResultSet() != null) {
            for (int i=0;
                 ...
                 i++) {
                Object obj = java.lang.reflect.Array.get(getResultSet(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(edu.tulane.museum.www.webservices.Georef_Result_Set.class, true);
